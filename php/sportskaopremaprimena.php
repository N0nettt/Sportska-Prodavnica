...
{
  $upit = "delete from sportskaoprema where sifra ='" . $_GET['id'] . "'";
...
<div class="row">
  ...
  <?php  
  {
    ...
    $upit = "select * from sportskaoprema";
    ...
    if($rez->num_rows>1)
    {
      while($row = $rez->fetch_assoc())
      {
        ...
        if($brojac >= 3 && $brojac % 3 == 0)
        {
          ...
          echo "</div>";
          echo "<div class='col-md-3'>";
          echo "<form method='post' action='sportska-oprema.php?action=add&id=" . $sifra . "'>";
          ...
          if(isset($_SESSION['role']))
          {
           ...
           {
            echo "<a href='sportska-oprema.php?action=delete&id=" . $sifra . "'><span class='text-danger'>Obrisi iz baze</span></a>";
          }
        }
