...
<div class="row">
  <div class="col-md-3">
      ...
      <select name="sort" id="sort" onchange="this.form.submit()">
        ...
        <option selected="selected" value="Opadajuce">Opadajuce</option>
  ...
  <?php  
  {
    ...
    $upit = "select * from sportskaoprema order by Cena desc";
    ...
    if($rez->num_rows>1)
    {
      while($row = $rez->fetch_assoc())
      {
        ...
        if($brojac >= 3 && $brojac % 3 == 0)
        {
          ...
          echo "</div>";
          echo "<div class='col-md-3'>";
          echo "<form method='post' action='sportska-oprema-opadajuce.php?action=add&id=" . $sifra . "'>";
