...
<div class="row">
  <div class="col-md-3">
    <form class="formBrend" id="myForm" name="formBrend"  method="post" action="zene-trenerke.php">
      ...
      if(isset($_POST['pretraga']))
      {
        ...
        $upit = "select * from trenerke where Brend in(" . $deoUpita . ") AND Tip in(" . $deoUpita1 . ") AND Velicina in (" . $deoUpita2 . ") AND Pol in('Z')";
        ...
        if($rez->num_rows>1)
        {
          while($row = $rez->fetch_assoc())
          {
            ...
            if($brojac >= 3 && $brojac % 3 == 0)
            {
              ...
              echo "</div>";
              echo "<div class='col-md-3'>";
              echo "<form method='post' action='zene-trenerke.php?action=add&id=" . $sifra . "'>";
              ...
              if(isset($_SESSION['role']))
              {
                ...
                {
                  echo "<a href='zene-trenerke.php?action=delete&id=" . $sifra . "'><span class='text-danger'>Obrisi iz baze</span></a>";
                }
              }
